...
export function buildDemoNotifications(recipientAddress: string, chainId: string | null): NotificationItem[] {
  ...
  return [
    { id: "demo-1", kind: "POST_LIKED", tokenId: tokenIdA, commentId: null, timestamp: baseTs - 20, actor: a1 },
    { id: "demo-2", kind: "POST_SAVED", tokenId: tokenIdB, commentId: null, timestamp: baseTs - 45, actor: a2 },
    { id: "demo-3", kind: "POST_COMMENTED", tokenId: tokenIdA, commentId: aC1, timestamp: baseTs - 80, actor: a3 },
    { id: "demo-4", kind: "COMMENT_LIKED", tokenId: tokenIdB, commentId: bC1, timestamp: baseTs - 120, actor: a2 },
    { id: "demo-5", kind: "COMMENT_SAVED", tokenId: tokenIdA, commentId: aC1, timestamp: baseTs - 180, actor: a1 },
    { id: "demo-6", kind: "COMMENT_REPLIED", tokenId: tokenIdB, commentId: bC2, timestamp: baseTs - 240, actor: a3 }
  ];
}
