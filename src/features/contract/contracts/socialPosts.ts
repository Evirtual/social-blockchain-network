...
export const SOCIAL_ABI = [
  ...
  "event ProtocolSupported(address indexed supporter, address indexed treasury, uint256 indexed tokenId, uint256 amountWei, uint16 supportBps)",
  ...
  "function authorTokenIdsSlice(address author, uint256 start, uint256 limit) external view returns (uint256[])",
  ...
  "function tipCommentWithSupport(uint256 tokenId, uint256 commentId, uint16 supportBps, bool savePreference) external payable",
